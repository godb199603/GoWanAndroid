...
import com.example.gowanandroid.ext.htmlToSpanned
import com.example.gowanandroid.ext.setBrightness
import com.example.gowanandroid.model.bean.Article
import com.example.gowanandroid.model.store.SettingsStore
import com.example.gowanandroid.ui.base.BaseVmActivity
...
import com.example.gowanandroid.util.isNightMode
import com.example.gowanandroid.util.whiteHostList
...
class DetailActivity : BaseVmActivity<DetailViewModel>() {
    ...
    override fun initData() {
        ...
        agentWeb = AgentWeb.with(this)
            ...
            .useDefaultIndicator(ContextCompat.getColor(App.Companion.instance,R.color.textColorPrimary), 2)
            .interceptUnkownUrl()
